    ...
    <PayPalScriptProvider options={{ "client-id": "Abo90Wztq8vanhzw0EO5zMhum7b1O6aI_1x4BTA8v7jqNIOGdthWxF-ZZpjhtEGg6CW0VWRdgg_hjdlb" }}>
      <PayPalButtons
        createOrder={(data, actions) => {
          return fetch('http://localhost:8080/sugarnest/v0.1/api/paypal/create-payment', {
            method: 'POST',
            headers: {
        ...
        onApprove={(data, actions) => {
          ...
          return fetch(`http://localhost:8080/sugarnest/v0.1/api/paypal/execute-payment?paymentId=${data.paymentID}&PayerID=${data.payerID}`)
